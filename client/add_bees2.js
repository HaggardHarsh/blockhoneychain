...
const startIndex = cinematicSource.indexOf('interface BeeProps {');
const endIndex = cinematicSource.indexOf('function Hero({');

if (startIndex === -1 || endIndex === -1) {
    console.error("Could not find extraction points");
    process.exit(1);
}

const beeComponents = cinematicSource.slice(startIndex, endIndex);
